      ...
      var i = (function () {
        function e(t, o, r) {
          return (
            ...
            "object" != (void 0 === o ? "undefined" : n(o)) || r
              ? (this.callback = o)
              : ((r = o), (this.callback = null)),
            (this.options = Object.assign({ timeout: 0, readyState: 4 }, r)),
            (this.element =
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this.elements.forEach(function (t) {
                    "VIDEO" == t.nodeName && e.videos.push(t),
                  ...
                  if (this.options.timeout > 0) {
                    var r = new Promise(function (t, o) {
                      var n = setTimeout(function () {
                        clearTimeout(n),
                          o("Load timed out (" + e.options.timeout + "ms)");
                      }, e.options.timeout);
                    });
                    n = Promise.race([n, r]);
                  }
                  return n.then(function () {
                    return (
                      "function" == typeof e.callback &&
                        e.callback.call(null, e.videos),
                      Promise.resolve(e.videos)
                    );
                  });
                },
              },
            ...
            [
              {
                ...
                value: function (t) {
                  (t = t || window.jQuery) &&
                    (t.fn.videosLoaded = function (t, o) {
